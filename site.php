...
<html class="no-js">
    ...
    <section class="userInterfaceBox uiBox">
        <div class="foodIcons">
    <div class="foodIcons--ketchup"></div><div class="foodIcons__text"><p class="foodIcons__text--bold"><a href="fooddiary.php">Dziennik żywieniowy</p><p>Zapisz swój jadłospis</p></a></div>
